                    ...
                    <article <?php post_class( 'uou-block-7f blog-post-content'); ?> id="post-<?php the_ID(); ?>" >
                     ...
                     <h4 class = "blog-title-heading"><?php the_title(); ?></h4>
                      ...
                      <div class="uou-share-story clearfix">
                        <div class="row">
                          <div class="col-sm-3">
                            <h5 class="sidebar-title"><?php esc_html_e('Share This Story', 'rentify'); ?></h5>
                          </div>
                          ...
                          <a href="<?php echo esc_url(home_url('/')); ?>" class="btn btn-primary "><?php esc_html_e('Back To Home', 'rentify'); ?></a>
                  </article>

              <div class="uou-post-comment">
               <aside class="uou-block-14a">
                  <h5><?php esc_html_e('Comments', 'rentify'); ?>
                    <?php 
                            if(comments_open() && !post_password_required()){
