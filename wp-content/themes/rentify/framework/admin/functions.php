...
function rentify_sidebar() {
  ...
  $args = array(
    'id'            => 'mainsidebar',
    'name'          => __( 'Blog Page Sidebar', 'rentify' ),   
    'description'   => __('Put your main sidebar widgets here','rentify'),  
    'before_widget' => '',
    'after_widget'  => '',
  ...
  register_sidebar( $args );
   ...
   $footer_left_sidebar = array(
    ...
    'name'          => __( 'Footer Left Sidebar', 'rentify' ),
    'description'   => __('Put your widgets here that show on footer left side area','rentify'),    
  ...
  $footer_middle_sidebar = array(
    ...
    'name'          => __( 'Footer Middle Sidebar', 'rentify' ),
    'description'   => __('Put your widgets here that show on footer middle area','rentify'), 
    'before_widget' => '<div class="col-md-3 col-sm-6">',
    'after_widget'  => '</div>',
    'before_title'  => '<h5>',
    'after_title'   => '</h5>',
 ...
 $footer_right_sidebar = array(
    ...
    'name'          => __( 'Footer Right Sidebar', 'rentify' ),
    'description'   => __('Put your widgets here that show on footer right side area example(newsletter)','rentify'), 
    'before_widget' => '',
    'after_widget'  => '',
    'before_title'  => '',
    'after_title'   => '',
  ...
  $footer_down_sidebar = array(
    ...
    'name'          => __( 'Footer Down Sidebar', 'rentify' ),
    'description'   => __('Put your widgets here that show on footer down side area example(contact info)','rentify'), 
    'before_widget' => '',
    'after_widget'  => '',
    'before_title'  => '',
    'after_title'   => '',
 ...
 $footer_extra_middle_sidebar = array(
    ...
    'name'          => __( 'Footer Extra Middle Sidebar', 'rentify' ),
    'description'   => __('Put your widgets here that show on footer extra middle side area','rentify'), 
