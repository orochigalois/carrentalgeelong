...
class Rentify_Widget_Newsletter extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		// $this->WP_Widget( 'newsletter', __( 'Newsletter', 'rentify' ), $widget_options, $control_options );
...
<?php
	...
	function form( $instance ) {
		//Defaults
		$defaults = array(
			'title' => esc_html__( 'Newsletter', 'rentify' ),
			'input_text' => esc_html__( 'you@site.com', 'rentify' ),
			'submit_text' => esc_html__( 'Subscribe', 'rentify' ),
			'id' => ''
		);
